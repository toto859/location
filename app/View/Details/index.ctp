				...
				<table cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
					<thead>
						<tr>
							...
							<th class="hidden"><?php echo $this->Paginator->sort('COM_VISIBLE'); ?></th>
							<th><?php echo $this->Paginator->sort('vehicule_id'); ?></th>
...
<?php foreach ($details as $detail): ?>
	<tr>
		<td class="hidden"><?php echo h($detail['Detail']['ID']); ?>&nbsp;</td>
		...
		<td class="hidden"><?php echo h($detail['Detail']['COM_VISIBLE']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($detail['Vehicule']['NOM'], array('controller' => 'vehicules', 'action' => 'view', $detail['Vehicule']['ID'])); ?>
		</td>
		<td class="actions">
