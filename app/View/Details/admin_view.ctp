...
</tr><tr>		<td><strong><?php echo __('Vehicules'); ?></strong></td>
		<td>
			<?php echo $this->Html->link($detail['Vehicules'][''], array('controller' => 'vehicules', 'action' => 'view', $detail['Vehicules']['id']), array('class' => '')); ?>
			&nbsp;
		</td>
</tr>					</tbody>
