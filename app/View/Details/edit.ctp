...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">
				<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Detail.ID')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Detail.ID'))); ?></li>
				...
				<li class="list-group-item"><?php echo $this->Html->link(__('New Vehicule'), array('controller' => 'vehicules', 'action' => 'add')); ?> </li>
			</ul><!-- /.list-group -->
		...
		<div class="details form">
			...
			<?php echo $this->Form->create('Detail', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('COM_VISIBLE', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
						<?php echo $this->Form->input('vehicule_id', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
